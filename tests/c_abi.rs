...
fn c_abi_every_setter_survives_live_and_null_sessions() {
    use rgmin::ffi::{
        ...
        rgmin_solver_set_so_n, rgmin_solver_set_stiefel,
    };
    let ctrl = rgmin_control_t {
        maxiter: 20,
        gtol: 1e-8,
    ...
    unsafe {
        ...
        rgmin_solver_set_so_n(session, 2);
        rgmin_solver_set_manifold(session, rgmin_manifold_t::RGMIN_MANIFOLD_SO_N);
        rgmin_solver_set_manifold(session, rgmin_manifold_t::RGMIN_MANIFOLD_SYMMETRIC);
    ...
    unsafe {
        ...
        rgmin_solver_set_so_n(null, 4);
        rgmin_solver_set_manifold(null, rgmin_manifold_t::RGMIN_MANIFOLD_SO_N);
