...
fn c_abi_every_setter_survives_live_and_null_sessions() {
    use rgmin::ffi::{
        ...
        rgmin_solver_set_stiefel, rgmin_solver_set_unitary,
    };
    let ctrl = rgmin_control_t {
        maxiter: 20,
        gtol: 1e-8,
    ...
    unsafe {
        ...
        rgmin_solver_set_unitary(null, 2);
        rgmin_solver_set_manifold(null, rgmin_manifold_t::RGMIN_MANIFOLD_UNITARY);
