 ...
 *  Token 20 is the complex unit sphere C^n (spherecomplexfactory). */
...
/** Complex unit sphere C^n. Packed interleaved, length 2n. manopt
 *  spherecomplexfactory. Token 20 defaults to n = 1. */
