...
#define xts_solver_set_so_n rgmin_solver_set_so_n
 ...
 *  SO3 is length 9; SE3 is length 12. SO(n) is n-by-n via
 *  xts_solver_set_so_n. Oblique is n-by-m via
...
/** SO(n), n >= 2. Packed row-major, length n*n. Distinct from SO3. */
void xts_solver_set_so_n(xts_solver_t *solver, size_t n);
