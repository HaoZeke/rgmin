...
no options database) when PETSc/SLEPc are present and the host
has already initialized them. PRIMME, ChASE, ELPA, ELPA2, SLATE,
MAGMA, cuSOLVER, DLA-Future, EigenExa, and unbuilt SLEPc return
``Error::EigenUnavailable`` until linked
