...
SE(3), Oblique token 11, Multinomial token 12, positive token 19,
realphase token 20, centered token 21. Reserved: 7 SPD,
8 Grassmann, 9 Hyperbolic, 10 Poincare, 15 SO(n), 16 SE(n), 17-18.
Hourglass mark and the Diataxis book under ~docs/orgmode/~.
