...
SE(3) factory parity with manopt ~specialeuclideanfactory(3)~ at
~k = 1~: SO(3) projection and QR retraction on the rotation,
Euclidean translation, transport by projection at arrival,
Frobenius inner product through ~vecops~, typical distance
~sqrt(3*(pi^2+1))~. A 3N cluster is refused. ~Se3~ stays the
dedicated 12-vector token.
