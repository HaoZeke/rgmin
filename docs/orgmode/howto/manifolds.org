...
| ~SoN { n }~ | row-major ~R~, length ~n^2~, ~n >= 2~ | QR with positive diagonal |
...
length other than 12. ~ComplexCircle { n }~ rejects any length
other than ~2 n~. They do not pack or prefix-interpret a 3N
cluster.
