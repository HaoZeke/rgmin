...
* Riemannian trust regions (manopt tCG)
...
manifolds/, [[https://doi.org/10.1007/s10208-005-0179-9][10.1007/s10208-005-0179-9]]. The Euclidean dogleg path is
unchanged (~Method::Dogleg~). A finite-difference Riemannian Hessian
(manopt ~getHessianFD~) covers first-order oracles: retract a scaled
tangent, transport the new Riemannian gradient back, divide. The
sphere's ~ehess2rhess~ subtracts the Weingarten term
~(x . egrad) u~ before projecting.
