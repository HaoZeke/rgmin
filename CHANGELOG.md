...
- `ManifoldKind::Constant`: manopt `constantfactory`. Singleton
  `{A}` of packed length `n`. Projection and transport vanish,
  retraction stays at the point. C token 17. Tokens 7-10 stay
  reserved.
