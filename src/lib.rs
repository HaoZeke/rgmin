...
pub mod dlaf_kind;
/// Closed ELPA stage and `nblk`. Compile without a linked ELPA.
pub mod elpa_kind;
...
pub use lowest_mode::{
    ...
    lowest_mode_primme, lowest_mode_libkrylov, lowest_mode_slepc, lowest_mode_dlaf, lowest_mode_eigenexa, ApplyHessian,
